...
smoothing_scale = Scale(root, from_=1, to=100, orient=tk.HORIZONTAL, label="Smoothing Factor",
...
dead_zone_scale = Scale(root, from_=1, to=50, orient=tk.HORIZONTAL, label="Dead Zone Radius",
                        command=update_dead_zone)
dead_zone_scale.set(20)  # Set initial value
dead_zone_scale.pack(pady=10)

# Create a Scale widget for delay
delay_scale = Scale(root, from_=1, to=100, orient=tk.HORIZONTAL, label="Delay",
